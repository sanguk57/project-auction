...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="width:380px;">
        <form class="row g-3" method="post">
            ...
            <div class="col-sm-12">
                <button class="btn btn-lg btn-primary w-100" type="button" id="passwordFind">비밀번호 찾기</button>
            </div>
        </form>
</div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.min.js"
      ...
      integrity="sha256-pvPw+upLPUjgMXY0G+8O0xUf+/Im1MZjXxxgOcBQBXU=" crossorigin="anonymous"></script>
        ...
        <script src="${path}/js/passwordFind.js?v=<%=System.currentTimeMillis() %>"></script>
</body>
