				...
				<div class="row gy-4">
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							...
							<h3>
								<a href="service-details" class="stretched-link">Storage</a>
							</h3>
							<p>Cumque eos in qui numquam. Aut aspernatur perferendis sed
								atque quia voluptas quisquam repellendus temporibus
								itaqueofficiis odit</p>
						</div>
					</div>
					<!-- End Card Item -->
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							<div class="card-img">
								<img src="/web/images/logistics-service.jpg" alt=""
									class="img-fluid">
							</div>
							<h3>
								<a href="service-details" class="stretched-link">Logistics</a>
							</h3>
							<p>Asperiores provident dolor accusamus pariatur dolore nam
								id audantium ut et iure incidunt molestiae dolor ipsam ducimus
								occaecati nisi</p>
						</div>
					</div>
					<!-- End Card Item -->
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							<div class="card-img">
								<img src="/web/images/cargo-service.jpg" alt="" class="img-fluid">
							</div>
							<h3>
								<a href="service-details" class="stretched-link">Cargo</a>
							</h3>
							<p>Dicta quam similique quia architecto eos nisi aut ratione
								aut ipsum reiciendis sit doloremque oluptatem aut et molestiae
								ut et nihil</p>
						</div>
					</div>
					<!-- End Card Item -->
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							<div class="card-img">
								<img src="/web/images/trucking-service.jpg" alt=""
									class="img-fluid">
							</div>
							<h3>
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							<div class="card-img">
								<img src="/web/images/packaging-service.jpg" alt=""
									class="img-fluid">
							</div>
							<h3>
								<a href="service-details" class="stretched-link">Packaging</a>
							</h3>
							<p>Illo consequuntur quisquam delectus praesentium modi
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="card">
							<div class="card-img">
								<img src="/web/images/warehousing-service.jpg" alt=""
									class="img-fluid">
							</div>
							<h3>
								<a href="service-details" class="stretched-link">Warehousing</a>
							</h3>
							<p>Quas assumenda non occaecati molestiae. In aut earum sed
								natus eatae in vero. Ab modi quisquam aut nostrum unde et qui
								est non quo nulla</p>
						</div>
					</div>
					<!-- End Card Item -->
