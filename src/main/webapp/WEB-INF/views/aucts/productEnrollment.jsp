...
<section id="get-a-quote" class="get-a-quote">
	<div class="container" data-aos="fade-up">
		<h2 class="text-center mb-2">판매 상품 등록</h2>
					...
					<div class="row gy-4">
						...
						<div class="col-md-4">
							<div class="form-floating">
								<input type="text" name="prod_name" id="prod_name"
									class="form-control form-control-sm" placeholder="상품 이름">
						...
						<div class="col-md-4">
							<div class="input-group mb-3">
								<input type="text" class="form-control d-none" id="category" 
									name="category" placeholder="카테고리" aria-label="category_chk"
									aria-describedby="category_chk"> 
									<select
						...
						<div class="col-md-4">
							<div class="form-floating">
								<input type="hidden" name="start_amt" id="start_amt"> <input
									type="text" name="start_amt_input"
						...
						<div class="col-md-3">
							<select class="form-select form-select-sm"
								...
								name="prod_type">
								<option selected disabled>중고 상품 유무</option>
						...
						<div class="col-md-3">
							<select class="form-select form-select-sm"
								...
								<option selected disabled>AS가능 여부</option>
						...
						<div class="col-md-3">
							<select class="form-select form-select-sm"
								...
								name="limit_type">
								<option selected disabled>즉시구매 가능 여부</option>
								<option value="Y">가능</option>
								<option value="N">불가능</option>
							</select>
						<input type="hidden" name="limit_amt" id="limit_amt" value="0">
						</div>


						<div class="col-md-3 d-none" id="d-none">
							<div class="form-floating">
								<input type="text" name="limit_amt_input" value="0"
									onchange="inputNumberFormat(this)" id="limit_amt_input"
									class="form-control form-control-sm" placeholder="경매시작 가격">
								<label for="limit_amt_input">즉시구매 가격</label>
							</div>
						</div>

						<div class="col-md-3">
							<input type="number" name="total_cnt" id="total_cnt"
								placeholder="경매상품 수량" class="form-control form-control-sm">
						</div>
						...
						<div class="col-md-3">
							<div class="form-floating">
								<input type="hidden" name="curr_amt" id="curr_amt"> <input
									...
									class="form-control form-control-sm" placeholder="현재 상품 가격"
									onchange="inputNumberFormat(this)" required> <label
									for="curr_amt_input">현재 상품 가격</label>
							</div>
						</div>
						...
						<div class="col-md-3">
							<select class="form-select form-select-sm"
								...
								name="trans_type">
								<option selected disabled>거래 방식</option>
						...
						<div class="col-md-3">
							<label for="exampleFormControlInput1" class="form-label">경매
								...
								id="auct_start" class="form-control form-control-sm"
								placeholder="경매 시작 날짜" required>
						</div>
						<div class="col-md-3">
							<label for="exampleFormControlInput1" class="form-label">경매
								종료 날짜</label> <input type="text" name="auct_end" id="auct_end"
								class="form-control form-control-sm" placeholder="경매 종료 날짜"
								required>
						</div>
						...
						<div class="col-md-4">
							<div class="input-group mb-3">
								<input type="text" class="form-control" placeholder="판매가능 지역"
									name="sales_addr" id="roadFullAddr"
						...
						<div class="col-md-12">
							<div class="form-floating">
								<textarea class="form-control"
									...
									id="contents" style="height: 150px"></textarea>
						...
						<div class="col-md-12">
							<button type="submit"
								class="btn btn-outline-secondary mt-3 w-100">등록하기</button>
						</div>
					</div>
				</div>
			</div>
...
function imageChange(event){
	...
	function inputNumberFormat(obj) {
		...
		console.log(document.querySelector("#limit_amt").value, document
				.querySelector("#limit_amt_input").value )
	}
